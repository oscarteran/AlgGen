...
program AG_fxy
   ...
   DirRes='/home/alejandro/Desktop/IDGB/P_Final/AlgGen/Electrica/DirResl/'
   ...
   M = 5_il                               ! Número de parámetros, dependiendo de la inversión
   ...
   !-----Electrica:
   pMin = [10._dp, 10._dp, 10._dp, 1._dp, 1._dp]
   pMax = [120._dp, 120._dp, 120._dp, 20._dp, 20._dp]
   ...
   do while (iGen <= NGen)
      ...
      do i=1,Q
         ...
         !Medio Electrico
         aux  = [Gen(i,1), Gen(i,2), Gen(i,3), Gen(i,4), Gen(i,5)]
         do it = 1,N
         	
         	Zest(it) = SEV(DatX(it), aux, 3)
	 end do
