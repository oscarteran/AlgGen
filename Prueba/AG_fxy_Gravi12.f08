...
program AG_fxy
   ...
   Pm = 0.05_dp                           ! Probabilidad de mutación (Cte: 5%)
   NGen = 10000_il                        ! Número máximo de generaciones
   Tol = 0.001_dp                         ! Tolerancia (c/R al error)
   !-----------------------------------------------------------------------------------------------!
   ...
   ! Espacio discreto de modelos:
      !Gravimetria
   pMin = [0.007_dp, 0.170_dp, 0.060_dp, -1500._dp, &
   	   0.005_dp, 0.340_dp, 0.060_dp, 1000._dp, &
   	   0.010_dp, 0.750_dp, 0.040_dp, 2500._dp]!posiciones de los minimos
   
   pMax = [0.01_dp, 0.200_dp, 0.080_dp, 1000._dp, &
   	 0.010_dp, 0.400_dp, 0.080_dp, 1500._dp, &
   	  0.020_dp, 0.775_dp, 0.080_dp, 3500._dp]!posiciones de los maximos
